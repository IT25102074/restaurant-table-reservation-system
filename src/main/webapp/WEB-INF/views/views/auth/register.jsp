...
<div class="w-full max-w-md glass-card rounded-2xl p-8 fade-in" style="box-shadow: 0 8px 40px rgba(0,0,0,0.4);">
    ...
    <div class="text-center mb-8">
        ...
        <p class="text-slate-400 mt-1.5 text-sm">Create your account</p>
    </div>
    ...
    <form action="/register" method="post" class="space-y-5">
        ...
        <div>
            <label class="block text-sm font-medium text-slate-300 mb-1.5">Password
                <span class="text-slate-500 font-normal">(min 6 characters)</span>
            </label>
    ...
    <p class="text-center text-sm text-slate-500 mt-6">
        ...
        <a href="/login" class="text-amber-400 font-medium hover:text-amber-300 transition">Login here</a>
    </p>
</div>
