...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Inter', sans-serif; }
        ...
        .particle:nth-child(1)  { width:10px; height:10px; left:8%;   animation-duration:13s; animation-delay:0s;   bottom:-20px; }
        .particle:nth-child(2)  { width:7px;  height:7px;  left:22%;  animation-duration:10s; animation-delay:2.5s; bottom:-20px; background:rgba(196,149,106,0.15); }
        .particle:nth-child(3)  { width:15px; height:15px; left:38%;  animation-duration:15s; animation-delay:4s;   bottom:-20px; }
        .particle:nth-child(4)  { width:5px;  height:5px;  left:52%;  animation-duration:9s;  animation-delay:1.5s; bottom:-20px; background:rgba(196,149,106,0.2); }
        .particle:nth-child(5)  { width:18px; height:18px; left:67%;  animation-duration:17s; animation-delay:3.5s; bottom:-20px; }
        .particle:nth-child(6)  { width:9px;  height:9px;  left:80%;  animation-duration:12s; animation-delay:6s;   bottom:-20px; background:rgba(196,149,106,0.12); }
        .particle:nth-child(7)  { width:12px; height:12px; left:28%;  animation-duration:11s; animation-delay:8s;   bottom:-20px; }
        .particle:nth-child(8)  { width:8px;  height:8px;  left:72%;  animation-duration:8s;  animation-delay:1s;   bottom:-20px; background:rgba(139,94,60,0.08); }
        @keyframes floatUp {
        ...
        @keyframes blobDrift1 { from { transform: translate(0,0) scale(1); } to { transform: translate(40px,30px) scale(1.1); } }
        @keyframes blobDrift2 { from { transform: translate(0,0) scale(1); } to { transform: translate(-30px,-20px) scale(1.08); } }
